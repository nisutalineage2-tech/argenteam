			...
			if (target instanceof L2PcInstance && weapon != null && weapon.getItemType() == WeaponType.DAGGER && skill != null)
				{
					...
					if (armor != null)
					{
						...
						{
							damage /= Config.DAGGER_DMG_VS_HEAVY;
						}
						if (((L2PcInstance) target).isWearingLightArmor())
						{
							damage /= Config.DAGGER_DMG_VS_LIGHT;
						}
						if (((L2PcInstance) target).isWearingMagicArmor())
						{
							damage /= Config.DAGGER_DMG_VS_ROBE;
						}
					}
				}
				if (target instanceof L2PcInstance && weapon != null && weapon.getItemType() == WeaponType.BOW && skill != null)
				{
					final Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
					if (armor != null)
					{
						if (((L2PcInstance) target).isWearingHeavyArmor())
						{
							damage /= Config.BOW_DMG_VS_HEAVY;
						}
						if (((L2PcInstance) target).isWearingLightArmor())
						{
							damage /= Config.BOW_DMG_VS_LIGHT;
						}
						if (((L2PcInstance) target).isWearingMagicArmor())
						{
							damage /= Config.BOW_DMG_VS_ROBE;
						}
					}
				}
				if (target instanceof L2PcInstance && weapon != null && weapon.getItemType() == WeaponType.BLUNT && skill != null)
				{
					final Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
					if (armor != null)
					{
						if (((L2PcInstance) target).isWearingHeavyArmor())
						{
							damage /= Config.BLUNT_DMG_VS_HEAVY;
						}
						if (((L2PcInstance) target).isWearingLightArmor())
						{
							damage /= Config.BLUNT_DMG_VS_LIGHT;
						}
						if (((L2PcInstance) target).isWearingMagicArmor())
						{
							damage /= Config.BLUNT_DMG_VS_ROBE;
						}
					}
				}
				if (target instanceof L2PcInstance && weapon != null && weapon.getItemType() == WeaponType.DUALFIST && skill != null)
				{
					final Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
					if (armor != null)
					{
						if (((L2PcInstance) target).isWearingHeavyArmor())
						{
							damage /= Config.FIST_DMG_VS_HEAVY;
						}
						if (((L2PcInstance) target).isWearingLightArmor())
						{
							damage /= Config.FIST_DMG_VS_LIGHT;
						}
						if (((L2PcInstance) target).isWearingMagicArmor())
						{
							damage /= Config.FIST_DMG_VS_ROBE;
						}
					}
				}
				if (target instanceof L2PcInstance && weapon != null && weapon.getItemType() == WeaponType.DUAL && skill != null)
				{
					...
					if (armor != null)
					{
						if (((L2PcInstance) target).isWearingHeavyArmor())
						{
							damage /= Config.DUAL_DMG_VS_HEAVY;
						}
						if (((L2PcInstance) target).isWearingLightArmor())
						{
							damage /= Config.DUAL_DMG_VS_LIGHT;
						}
						if (((L2PcInstance) target).isWearingMagicArmor())
						{
							damage /= Config.DUAL_DMG_VS_ROBE;
						}
					}
				}
				if (target instanceof L2PcInstance && weapon != null && weapon.getItemType() == WeaponType.SWORD && skill != null)
				{
					final Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
					if (armor != null)
					{
						if (((L2PcInstance) target).isWearingHeavyArmor())
						{
							damage /= Config.SWORD_DMG_VS_HEAVY;
						}
						if (((L2PcInstance) target).isWearingLightArmor())
						{
							damage /= Config.SWORD_DMG_VS_LIGHT;
						}
						if (((L2PcInstance) target).isWearingMagicArmor())
						{
							damage /= Config.SWORD_DMG_VS_ROBE;
						}
					}
				}
				if (target instanceof L2PcInstance && weapon != null && weapon.getItemType() == WeaponType.POLE && skill != null)
				{
					final Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
					if (armor != null)
					{
						if (((L2PcInstance) target).isWearingHeavyArmor())
						{
							damage /= Config.POLE_DMG_VS_HEAVY;
						}
						if (((L2PcInstance) target).isWearingLightArmor())
						{
							damage /= Config.POLE_DMG_VS_LIGHT;
						}
						if (((L2PcInstance) target).isWearingMagicArmor())
						{
							damage /= Config.POLE_DMG_VS_ROBE;
						}
					}
				}
