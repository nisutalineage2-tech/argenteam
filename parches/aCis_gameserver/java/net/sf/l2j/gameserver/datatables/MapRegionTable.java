...
public class MapRegionTable
{
	...
	public Location getTeleToLocation(L2Character activeChar, TeleportWhereType teleportWhere)
	{
		...
		switch (activeChar.getActingPlayer().getFactionId())
		{
			case 1:
				realLoc = Config.FACTION_TEAM1_BASE;
				return getTown(realLoc[0] + Rnd.get(realLoc[3], realLoc[4]), realLoc[1] + Rnd.get(realLoc[3], realLoc[4]), realLoc[2]).getSpawnLoc();
			case 2:
