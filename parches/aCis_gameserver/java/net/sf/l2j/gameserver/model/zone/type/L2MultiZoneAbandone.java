 ...
 * @author rapfersan92
 */
public class L2MultiZoneAbandone extends L2ZoneType
{
	...
	private static List<Location> _abandone1 = new ArrayList<>();
	private static List<Location> _abandone2 = new ArrayList<>();
	private static List<Integer> _restrictedItems = new ArrayList<>();
	private static List<Integer> _restrictedSkills = new ArrayList<>();
	
	public L2MultiZoneAbandone(int id)
	{
		super(id);
	...
	public void setParameter(String name, String value)
	{
		...
		else if (name.equals("abandone1"))
		{
			String[] property = value.split(";");
			for (String data : property)
			{
				String[] coordinates = data.split(",");
				_abandone1.add(new Location(Integer.parseInt(coordinates[0]), Integer.parseInt(coordinates[1]), Integer.parseInt(coordinates[2])));
			}
		}
		else if (name.equals("abandone2"))
		{
			String[] property = value.split(";");
			for (String data : property)
			{
				String[] coordinates = data.split(",");
				_abandone2.add(new Location(Integer.parseInt(coordinates[0]), Integer.parseInt(coordinates[1]), Integer.parseInt(coordinates[2])));
			}
		}
	...
	private static void respawnCharacter(L2Character character)
	{
		...
		if (activeChar.getFactionId() == 1)
		{
			...
			character.teleToLocation(Rnd.get(_abandone1), 20);
		}
		...
		{
			character.doRevive(_revivePower);
			character.teleToLocation(Rnd.get(_abandone2), 20);
		}
		}
	}
