 ...
 * @author DarthVader
 */
public class L2Team2Zone extends L2ZoneType
{
	public L2Team2Zone(int id)
	{
		super(id);
	}
	...
	protected void onEnter(L2Character character)
	{
		if (character instanceof L2PcInstance) {
			if (((L2PcInstance) character).getFactionId() != 2) {
			...
			if (((L2SummonInstance) character).getOwner().getFactionId() != 2) {
