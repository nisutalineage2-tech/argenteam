 ...
 * @author DarthVader
 */
public class L2Team1Zone extends L2ZoneType
{
	public L2Team1Zone(int id)
	{
		super(id);
	}
	...
	protected void onEnter(L2Character character)
	{
		...
		{
			if (((L2PcInstance) character).getFactionId() != 1)
			{
		...
		{
			if (((L2SummonInstance) character).getOwner().getFactionId() != 1)
			{
