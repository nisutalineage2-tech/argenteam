...
public class L2MultiZone extends L2ZoneType
{
	...
	private static List<Location> _reviveLocations2 = new ArrayList<>();
	...
	public void setParameter(String name, String value)
	{
		...
		else if (name.equals("reviveLocations2"))
		{
			String[] property = value.split(";");
			for (String data : property)
			{
				String[] coordinates = data.split(",");
				_reviveLocations2.add(new Location(Integer.parseInt(coordinates[0]), Integer.parseInt(coordinates[1]), Integer.parseInt(coordinates[2])));
			}
		}
	...
	private static void respawnCharacter(L2Character character)
	{
		...
		{
			character.doRevive(_revivePower);
			character.teleToLocation(Rnd.get(_reviveLocations2), 20);
		}
		}
	}
