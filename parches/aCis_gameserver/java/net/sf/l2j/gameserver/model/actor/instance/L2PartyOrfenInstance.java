...
/**
 * @author `Heroin, Gandalf chuchuki, fissban, Robertblack
 */
public class L2PartyOrfenInstance extends L2NpcInstance
{
	// -------------------------------------
	// Teleport Location Coordinates X,Y,Z.
	// Use /loc command in game to find them.
	private static final int locationX = Config.NPC_PT_5TELEPORTER_X; // npc id
	private static final int locationY = Config.NPC_PT_5TELEPORTER_Y; // npc id
	private static final int locationZ = Config.NPC_PT_5TELEPORTER_Z; // npc id
	// -------------------------------------
	// -------------------------------------
	...
	public L2PartyOrfenInstance(int objectId, NpcTemplate template)
	{
