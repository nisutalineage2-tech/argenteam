...
public final class Config
{
	...
	public static boolean AURA_TEAM_ENABLE;	
	
	// XXX custom ---------------------------------------------------------------------------------
	
	/** AntiPlayer */
	public static int ANTI_PLAYER_TIME;
	/** Offline stores */
	...
	// --------------------------------------------------
	public static Map<Integer, Integer> FACTION_FLAG_REWARDS_1 = new HashMap<>();
	public static Map<Integer, Integer> FACTION_FLAG_REWARDS_2 = new HashMap<>();
	public static Map<Integer, Integer> FACTION_FLAG_REWARDS_3 = new HashMap<>();
	public static boolean FACTION_ENABLE_KILLS_LIMIT_A;
	public static int FACTION_PVP_A_GRADE;
	public static boolean FACTION_ENABLE_GUARDS;
	public static boolean FACTION_ENABLE_MEM_BALANCE_ONLOG;
	public static boolean FACTION_ENABLE_KILLS_LIMIT;
	public static int FACTION_PLAYER_REWARDPP_INC;
	public static boolean FACTION_ENABLE_SPEAKS;
	public static String FACTION_TEAM1_PLAYER_VC;
	public static String FACTION_TEAM1_NPC_VC;
	public static String FACTION_TEAM2_PLAYER_VC;
	public static String FACTION_TEAM2_NPC_VC;
	public static boolean FACTION_ENABLE_CHAOS_EVENT;
	public static int CHAOS_EVENT_HASTE_LVL;
	public static int CHAOS_EVENT_DURATION_TIME;
	public static int CHAOS_EVENT_INTERVAL;
	public static int CHAOS_EVENT_REWARD_ID;
	public static boolean REVIVE_BASE_FACTION;	
	public static int CHAOS_EVENT_REWARD_AMOUNT;
	public static boolean FACTION_ENABLE_VOTE_MAP;
	public static int CLASS_BALANCE_MCRIT;
	public static double CLASS_BALANCE_MATK;
	public static int FACTION_PVP_KILLS_SHOP;
	public static boolean FACTION_ENABLE_ANTI_HEAVY;
	public static boolean FACTION_ENABLE_MULTIREWARD_CASTLE;
	public static int FACTION_MULTIPLE_REWARD_ADEN;
	public static int FACTION_MULTIPLE_REWARD_DION;
	public static int FACTION_MULTIPLE_REWARD_GLUDIO;
	public static int FACTION_MAP_DURATION;
	public static int FACTIONS_WIN_REWARD_ID;
	public static int FACTIONS_WIN_REWARD_AMOUNT;
	public static boolean FACTION_ENABLE_FIRST_PLC_AA;
	public static boolean FACTION_ENABLE_CLASS_BLNC;
	public static boolean FACTIONS_WIN_REWARD_ENABLED;
	public static boolean FACTION_TELEPORT_ON_VOTE;
	public static String FACTION_ENCHANT_SYSTEM_TYPE;
	public static int FACTION_ENCHANT_SYSTEM_CHANCE;
	public static int FACTION_MAX_ENCHANT;
	public static int FACTION_ENCHANT_B;
	public static int FACTION_ENCHANT_A;
	public static int FACTION_ENCHANT_S;
	public static int FACTION_CHANGE_PRICE;
	...
	public static int FACTION_PARTY_REWARD_ITM_ID;
	public static String FACTION_TEAM1_NAME;
	public static String FACTION_TEAM2_NAME;
	public static int[] FACTION_TEAM1_BASE;
	public static int[] FACTION_TEAM2_BASE;
	public static int[] FACTION_NEWBIE_BASE;
	...
	public static int FACTION_SP_REWARD_FIRST_RANK;
	public static int FACTION_ADENA_REWARD_FIRST_RANK;
	public static int FACTION_AA_REWARD_FIRST_RANK;
	public static int FACTION_ADENA_REWARD_SECOND_RANK;
	public static int FACTION_ADENA_REWARD_THIRD_RANK;
	public static boolean ENABLE_ITEM_REWARD_TOP;
	public static int FACTION_ITEM_REWARD_TOP_ID;
	public static int FACTION_ITEM_REWARD_TOP_AMOUNT;
	...
	public static boolean FACTION_LOSE_POINTS_DEATH;
	public static int FACTION_LOSE_POINTS_AMOUNT;
	public static boolean RESPAWN_FACTION_BASE;	
	...
	public static boolean ENABLE_PROTECTION_SAME_PLAYER;
	...
	public static int NPC_PT_1TELEPORTER_X;
	public static int NPC_PT_1TELEPORTER_Y;
	public static int NPC_PT_1TELEPORTER_Z;
	
	public static int NPC_PT_2TELEPORTER_X;
	public static int NPC_PT_2TELEPORTER_Y;
	public static int NPC_PT_2TELEPORTER_Z;
	
	public static int NPC_PT_3TELEPORTER_X;
	public static int NPC_PT_3TELEPORTER_Y;
	public static int NPC_PT_3TELEPORTER_Z;
	
	public static int NPC_PT_4TELEPORTER_X;
	public static int NPC_PT_4TELEPORTER_Y;
	public static int NPC_PT_4TELEPORTER_Z;
	
	public static int NPC_PT_5TELEPORTER_X;
	public static int NPC_PT_5TELEPORTER_Y;
	public static int NPC_PT_5TELEPORTER_Z;
	
	public static int NPC_PT_6TELEPORTER_X;
	public static int NPC_PT_6TELEPORTER_Y;
	public static int NPC_PT_6TELEPORTER_Z;
	
	public static int NPC_PT_7TELEPORTER_X;
	public static int NPC_PT_7TELEPORTER_Y;
	public static int NPC_PT_7TELEPORTER_Z;
	
	public static int NPC_PT_8TELEPORTER_X;
	public static int NPC_PT_8TELEPORTER_Y;
	public static int NPC_PT_8TELEPORTER_Z;
	
	public static int NPC_PT_9TELEPORTER_X;
	public static int NPC_PT_9TELEPORTER_Y;
	public static int NPC_PT_9TELEPORTER_Z;
	...
	public static int NpcBuffer_MaxDances;
	public static int NpcBuffer_MaxBuffs;
	...
	public static boolean ALT_OLY_ANNOUNCE_GAMES;
	  ...
	  public static int MAX_pDef_Rate;
...
/** Balance Class */
	public static float DAGGER_DMG_VS_HEAVY;
		public static float DAGGER_DMG_VS_LIGHT;
		public static float DAGGER_DMG_VS_ROBE;
		public static float BOW_DMG_VS_HEAVY;
		public static float BOW_DMG_VS_LIGHT;
		public static float BOW_DMG_VS_ROBE;
		public static float BLUNT_DMG_VS_HEAVY;
		public static float BLUNT_DMG_VS_LIGHT;
		public static float BLUNT_DMG_VS_ROBE;
		public static float FIST_DMG_VS_HEAVY;
		public static float FIST_DMG_VS_LIGHT;
		public static float FIST_DMG_VS_ROBE;
		public static float DUAL_DMG_VS_HEAVY;
		public static float DUAL_DMG_VS_LIGHT;
		public static float DUAL_DMG_VS_ROBE;
		public static float SWORD_DMG_VS_HEAVY;
		public static float SWORD_DMG_VS_LIGHT;
		public static float SWORD_DMG_VS_ROBE;
		public static float POLE_DMG_VS_HEAVY;
		public static float POLE_DMG_VS_LIGHT;
		public static float POLE_DMG_VS_ROBE;
	...
	private static final void loadPlayers()
	{
	    ...
	    WAR_LEGEND_AURA = Boolean.parseBoolean(players.getProperty("WarLegendAura", "False"));
		KILLS_TO_GET_WAR_LEGEND_AURA = Integer.parseInt(players.getProperty("KillsToGetWarLegendAura", "30"));		
		String[] array = KARMA_NONDROPPABLE_PET_ITEMS.split(",");
		KARMA_LIST_NONDROPPABLE_PET_ITEMS = new int[array.length];
		ALLOW_STATS_COMMAND = players.getProperty("StatsCommand", false);
		RESPAWN_FACTION_BASE = players.getProperty("RespawnFactionBase", false);
		...
		STORE_SKILL_COOLTIME = players.getProperty("StoreSkillCooltime", true);
		       ...
		       NEWBIE_LVL = Integer.parseInt(players.getProperty("NewbiesLevel", "80"));

		        NEWBIE_FIGHTER_SET = players.getProperty("FighterSet", "2375,3500,3501,3502,4422,4423,4424,4425,6648,6649,6650");

		       NEWBIE_MAGE_SET = players.getProperty("MageSet", "2375,3500,3501,3502,4422,4423,4424,4425,6648,6649,6650");
		       ...
		       SETX = players.getProperty("LocX", 83278);

		       SETY = players.getProperty("LocY", 148273);

		       SETZ = players.getProperty("LocZ", -3407);
		...
		DAGGER_DMG_VS_HEAVY = Float.parseFloat(players.getProperty("DaggerVsHeavy", "1.00"));
				DAGGER_DMG_VS_LIGHT = Float.parseFloat(players.getProperty("DaggerVsHeavy", "1.00"));
				DAGGER_DMG_VS_ROBE = Float.parseFloat(players.getProperty("DaggerVsHeavy", "1.00"));
				
				BOW_DMG_VS_HEAVY = Float.parseFloat(players.getProperty("BowVsHeavy", "1.00"));
				BOW_DMG_VS_LIGHT = Float.parseFloat(players.getProperty("BowVsHeavy", "1.00"));
				BOW_DMG_VS_ROBE = Float.parseFloat(players.getProperty("BowVsHeavy", "1.00"));
				
				BLUNT_DMG_VS_HEAVY = Float.parseFloat(players.getProperty("BluntVsHeavy", "1.00"));
				BLUNT_DMG_VS_LIGHT = Float.parseFloat(players.getProperty("BluntVsHeavy", "1.00"));
				BLUNT_DMG_VS_ROBE = Float.parseFloat(players.getProperty("BluntVsHeavy", "1.00"));
				
				FIST_DMG_VS_HEAVY = Float.parseFloat(players.getProperty("FistVsHeavy", "1.00"));
				FIST_DMG_VS_LIGHT = Float.parseFloat(players.getProperty("FistVsHeavy", "1.00"));
				FIST_DMG_VS_ROBE = Float.parseFloat(players.getProperty("FistVsHeavy", "1.00"));
				
				DUAL_DMG_VS_HEAVY = Float.parseFloat(players.getProperty("DualVsHeavy", "1.00"));
				DUAL_DMG_VS_LIGHT = Float.parseFloat(players.getProperty("DualVsHeavy", "1.00"));
				DUAL_DMG_VS_ROBE = Float.parseFloat(players.getProperty("DualVsHeavy", "1.00"));
				
				SWORD_DMG_VS_HEAVY = Float.parseFloat(players.getProperty("SwordVsHeavy", "1.00"));
				SWORD_DMG_VS_LIGHT = Float.parseFloat(players.getProperty("SwordVsHeavy", "1.00"));
				SWORD_DMG_VS_ROBE = Float.parseFloat(players.getProperty("SwordVsHeavy", "1.00"));
				
				POLE_DMG_VS_HEAVY = Float.parseFloat(players.getProperty("PoleVsHeavy", "1.00"));
				POLE_DMG_VS_LIGHT = Float.parseFloat(players.getProperty("PoleVsHeavy", "1.00"));
				POLE_DMG_VS_ROBE = Float.parseFloat(players.getProperty("PoleVsHeavy", "1.00"));
						
		
			
					PVP_PK_TITLE = Boolean.parseBoolean(players.getProperty("PvpPkTitle", "True"));
					PVP_TITLE_PREFIX = players.getProperty("PvPTitlePrefix", " ");

		
		
		
		ANTI_PLAYER_TIME = Integer.parseInt(players.getProperty("AntiPlayerTime", "10"));
		
		GLOBAL_CHAT_WITH_PVP = players.getProperty("GlobalChatWithPvP", false);
		GLOBAL_PVP_AMOUNT = players.getProperty("GlobalPvPAmount", 1500);
		TRADE_CHAT_WITH_PVP = players.getProperty("TradeChatWithPvP", false);
		TRADE_PVP_AMOUNT = players.getProperty("TradePvPAmount", 1500);
		          ...
		          MAX_pDef_Rate = players.getProperty("MaxAccuracy", 300);
	...
	private static final void loadServer()
	{
		...
		PROTOCOL_REVISION = server.getProperty("ProtocolRevision", 515);
	...
	{
		final ExProperties factionEngine = initProperties(FACTION_ENGINE_FILE);
		
		FACTION_ENABLE_KILLS_LIMIT_A = factionEngine.getProperty("FactionEnableAGradeLimit", false);
		FACTION_PVP_A_GRADE = factionEngine.getProperty("FactionKillsForAGradeItem", 100);
		FACTION_ENABLE_GUARDS = factionEngine.getProperty("FactionEnableFactionGuards", false);
		FACTION_ENABLE_MEM_BALANCE_ONLOG = factionEngine.getProperty("FactionEnablePlayersBalanceLogin", false);
		FACTION_ENABLE_VOTE_MAP = factionEngine.getProperty("FactionEnableMapVoting", false);
		FACTION_ENABLE_ANTI_HEAVY = factionEngine.getProperty("FactionEnableAntiHeavySystem", true);
		FACTION_ENABLE_KILLS_LIMIT = factionEngine.getProperty("FactionForbidUseItem", false);
		FACTION_PVP_KILLS_SHOP = factionEngine.getProperty("FactionKillsForSpecShop", 4000);
		FACTION_ENABLE_MULTIREWARD_CASTLE = factionEngine.getProperty("FactionEnableMultipleCastleReward", true);
		FACTION_MULTIPLE_REWARD_ADEN = factionEngine.getProperty("FactionIncreas);ardAden", 4);
		FACTION_MULTIPLE_REWARD_DION = factionEngine.getProperty("FactionIncreaseRewardDion", 3);
		FACTION_MULTIPLE_REWARD_GLUDIO = factionEngine.getProperty("FactionIncreaseRewardGludio", 2);
		FACTION_ENABLE_FIRST_PLC_AA = factionEngine.getProperty("FactionEnableAaRewardFirstPlace", true);
		FACTION_ENABLE_CLASS_BLNC = factionEngine.getProperty("FactionEnableClassBalance", true);
		FACTION_MAP_DURATION = factionEngine.getProperty("MapTimeDuration", 60);
		FACTION_TELEPORT_ON_VOTE = factionEngine.getProperty("FactionEnableAutoTeleportToBase", false);
		AURA_TEAM_ENABLE = factionEngine.getProperty("FactionAuraTeamEnable", false);
		FACTION_ENCHANT_SYSTEM_TYPE = factionEngine.getProperty("FactionEnchantSystemType", "OFF");
		FACTION_ENCHANT_SYSTEM_CHANCE = factionEngine.getProperty("FactionEnchantScrollsDropChance", 5);
		REVIVE_BASE_FACTION = factionEngine.getProperty("ReviveBaseFaction", false);
		
		FACTION_MAX_ENCHANT = factionEngine.getProperty("MaxItemEnchant", 16);
		FACTION_ENCHANT_B = factionEngine.getProperty("KillsForEnchantB", 25);
		FACTION_ENCHANT_A = factionEngine.getProperty("KillsForEnchantA", 50);
		FACTION_ENCHANT_S = factionEngine.getProperty("KillsForEnchantS", 150);
		FACTION_CHANGE_PRICE = factionEngine.getProperty("PriceForFactionChange", 29);
		...
		FACTION_ENABLE_SPEAKS = factionEngine.getProperty("FactionEnableSayTexts", true);
		FACTION_TEAM1_PLAYER_VC = factionEngine.getProperty("Team1PlayerText", "blabla");
		FACTION_TEAM1_NPC_VC = factionEngine.getProperty("Team1NpcText", "blabla");
		FACTION_TEAM2_PLAYER_VC = factionEngine.getProperty("Team2PlayerText", "blabla");
		FACTION_TEAM2_NPC_VC = factionEngine.getProperty("Team2NpcText", "blabla");
		...
		FACTION_START_LVL = factionEngine.getProperty("StartingLevel", 1);
		FACTION_START_LVL_SUB = factionEngine.getProperty("StartingLevelSubClass", 40);
		FACTION_ALLOW_ITEM_REWARD = factionEngine.getProperty("FactionPlayerGetItemByPvP", false);
		FACTION_ITEM_NUMBER_REWARD_ON_PVP = factionEngine.getProperty("FactionEngineAmmountItemRewardPvp", 3);
		FACTION_ITEM_REWARD_ID_PVP = factionEngine.getProperty("FactionPvPItemRewardID", 57);
		FACTION_ALLOW_ITEM_REWARD_PARTY = factionEngine.getProperty("FactionPlayerGetItemByPvPInParty", false);
		FACTION_ONLYSUPPORTS = factionEngine.getProperty("PartyRewardOnlySupportClass", false);
		FACTION_CHANCE = factionEngine.getProperty("Chance", 100);
		FACTION_PLAYER_REWARDPP_INC = factionEngine.getProperty("FactionPlayerRewardIfPp", 2);
		FACTION_PARTY_REWARD_ITM_ID = factionEngine.getProperty("FactionRewardPvpItmId", 57);
		FACTION_ALLOW_SP_REWARD_FLAG = factionEngine.getProperty("FactionPlayerGetSpItemFlag", false);
		FACTION_SP_REWARD_FIRST_FLAG = factionEngine.getProperty("FactionEngineAmmountSpFirstFlag", 1000);
		FACTION_SP_REWARD_SECOND_FLAG = factionEngine.getProperty("FactionEngineAmmountSpSecondFlag", 500);
		FACTION_SP_REWARD_THIRD_FLAG = factionEngine.getProperty("FactionEngineAmmountSpThirdFlag", 250);
		
		String[] flagRSplit = factionEngine.getProperty("FactionFlagReward1", "").split(";");
		for (String readData : flagRSplit)
		{
			String[] writeData = readData.split(",");
			if (writeData.length != 2)
			{
				System.out.println("Invalid faction flag rewards config.");
			}
			else
			{
				try
				{
					FACTION_FLAG_REWARDS_1.put(Integer.parseInt(writeData[0]), Integer.parseInt(writeData[1]));
				}
		...
		flagRSplit = factionEngine.getProperty("FactionFlagReward2", "").split(";");
		for (String readData : flagRSplit)
		{
			String[] writeData = readData.split(",");
			if (writeData.length != 2)
			...
			else
			{
				try
				{
					FACTION_FLAG_REWARDS_2.put(Integer.parseInt(writeData[0]), Integer.parseInt(writeData[1]));
				}
				catch (NumberFormatException nfe)
				{
					if (!readData.equals(""))
		...
		flagRSplit = factionEngine.getProperty("FactionFlagReward3", "").split(";");
		for (String readData : flagRSplit)
		{
			String[] writeData = readData.split(",");
			if (writeData.length != 2)
			...
			else
			{
				try
				{
					FACTION_FLAG_REWARDS_3.put(Integer.parseInt(writeData[0]), Integer.parseInt(writeData[1]));
				}
				catch (NumberFormatException nfe)
				{
					if (!readData.equals(""))
		...
		FACTION_ALLOW_EXP_REWARD = factionEngine.getProperty("FactionPlayerGetExp", false);
		FACTION_EXP_REWARD_PVP_FIRST = factionEngine.getProperty("FactionExpRewardInPvpFirst", 1000000);
		FACTION_EXP_REWARD_PVP_SECOND = factionEngine.getProperty("FactionExpRewardInPvpSecond", 500000);
		FACTION_EXP_REWARD_PVP_THIRD = factionEngine.getProperty("FactionExpRewardInPvpThird", 250000);
		FACTION_POINTS_FLAG = factionEngine.getProperty("FactionPointsRewardFlag", 5);
		FACTION_POINTS_PVP = factionEngine.getProperty("FactionPointsRewardPvp", 3);
		FACTION_LOSE_POINTS_DEATH = factionEngine.getProperty("PlayerLosePointsOnDeath", true);
		FACTION_LOSE_POINTS_AMOUNT = factionEngine.getProperty("FactionPointsLoseAmount", 1);
		FACTION_SP_REWARD_FIRST_RANK = factionEngine.getProperty("FactionEngineAmmountSpForFirstPlace", 1000);
		FACTION_ADENA_REWARD_FIRST_RANK = factionEngine.getProperty("FactionEngineAmmountAdenaFirstPlace", 40);
		FACTION_AA_REWARD_FIRST_RANK = factionEngine.getProperty("FactionEngineAmmountAaFirstPlace", 20);
		FACTION_ADENA_REWARD_SECOND_RANK = factionEngine.getProperty("FactionEngineAmmountAdenaSecondPlace", 20);
		FACTION_ADENA_REWARD_THIRD_RANK = factionEngine.getProperty("FactionEngineAmmountAdenaThirdPlace", 20);
		ENABLE_ITEM_REWARD_TOP = factionEngine.getProperty("EnableItemRewardForTopPlayer", false);
		FACTION_ITEM_REWARD_TOP_ID = factionEngine.getProperty("FactionItemRewardTopId", 57);
		FACTION_ITEM_REWARD_TOP_AMOUNT = factionEngine.getProperty("FactionItemRewardTopAmount", 1);
		FACTIONS_WIN_REWARD_ENABLED = factionEngine.getProperty("EnableRewardWinFaction", false);
		FACTIONS_WIN_REWARD_ID = factionEngine.getProperty("FactionRewardWinFactionId", 57);
		FACTIONS_WIN_REWARD_AMOUNT = factionEngine.getProperty("FactionRewardWinFactionAmount", 2);
		
		// baium
		NPC_PT_1TELEPORTER_X = factionEngine.getProperty("BaiumPtTeleportX", -56742);
		NPC_PT_1TELEPORTER_Y = factionEngine.getProperty("BaiumPtTeleportY", 140569);
		NPC_PT_1TELEPORTER_Z = factionEngine.getProperty("BaiumPtTeleportZ", -2625);
		// valakas
		NPC_PT_2TELEPORTER_X = factionEngine.getProperty("ValakasPtTeleportX", -56742);
		NPC_PT_2TELEPORTER_Y = factionEngine.getProperty("ValakasPtTeleportY", 140569);
		NPC_PT_2TELEPORTER_Z = factionEngine.getProperty("ValakasPtTeleportZ", -2625);
		// antharas
		NPC_PT_3TELEPORTER_X = factionEngine.getProperty("AntharasPtTeleportX", -56742);
		NPC_PT_3TELEPORTER_Y = factionEngine.getProperty("AntharasPtTeleportY", 140569);
		NPC_PT_3TELEPORTER_Z = factionEngine.getProperty("AntharasPtTeleportZ", -2625);
		// zaken
		NPC_PT_4TELEPORTER_X = factionEngine.getProperty("ZakenPtTeleportX", -56742);
		NPC_PT_4TELEPORTER_Y = factionEngine.getProperty("ZakenPtTeleportY", 140569);
		NPC_PT_4TELEPORTER_Z = factionEngine.getProperty("ZakenPtTeleportZ", -2625);
		// orfeb
		NPC_PT_5TELEPORTER_X = factionEngine.getProperty("OrfenPtTeleportX", -56742);
		NPC_PT_5TELEPORTER_Y = factionEngine.getProperty("OrfenPtTeleportY", 140569);
		NPC_PT_5TELEPORTER_Z = factionEngine.getProperty("OrfenPtTeleportZ", -2625);
		// core
		NPC_PT_6TELEPORTER_X = factionEngine.getProperty("CorePtTeleportX", -56742);
		NPC_PT_6TELEPORTER_Y = factionEngine.getProperty("CorePtTeleportY", 140569);
		NPC_PT_6TELEPORTER_Z = factionEngine.getProperty("CorePtTeleportZ", -2625);
		// frinteza
		NPC_PT_7TELEPORTER_X = factionEngine.getProperty("FrintezzaPtTeleportX", -56742);
		NPC_PT_7TELEPORTER_Y = factionEngine.getProperty("FrintezzaPtTeleportY", 140569);
		NPC_PT_7TELEPORTER_Z = factionEngine.getProperty("FrintezzaPtTeleportZ", -2625);
		// highp
		NPC_PT_8TELEPORTER_X = factionEngine.getProperty("HighPtTeleportX", -56742);
		NPC_PT_8TELEPORTER_Y = factionEngine.getProperty("HighPtTeleportY", 140569);
		NPC_PT_8TELEPORTER_Z = factionEngine.getProperty("HighPtTeleportZ", -2625);
		// queen
		NPC_PT_9TELEPORTER_X = factionEngine.getProperty("QueenPtTeleportX", -56742);
		NPC_PT_9TELEPORTER_Y = factionEngine.getProperty("QueenPtTeleportY", 140569);
		NPC_PT_9TELEPORTER_Z = factionEngine.getProperty("QueenPtTeleportZ", -2625);
		
		NPC_ID_PT_TELEPORTER = factionEngine.getProperty("NpcPtTeleporterId", 36614);
		NPC_PT_TELEPORTER_X = factionEngine.getProperty("PtTeleportX", -56742);
		NPC_PT_TELEPORTER_Y = factionEngine.getProperty("PtTeleportY", 140569);
		NPC_PT_TELEPORTER_Z = factionEngine.getProperty("PtTeleportZ", -2625);
		NPC_PT_ZONEID = factionEngine.getProperty("NpcPtZoneID", 155);
		NPC_PT_MINPT_MEMBERS = factionEngine.getProperty("NpcPtMinPartyMembers", 2);
		NPC_PT_ITEMCONSUME_ID = factionEngine.getProperty("NpcPtConsumeItemId", 57);
		NPC_PT_ITEMCOMSUME_QT = factionEngine.getProperty("NpcPtConsumeItemQt", 100);
		NPC_PT_SHOWINSIDE_PLAYERS = factionEngine.getProperty("NpcPtShowInsidePlayers", true);
		NPC_PT_SHOWINSIDE_PARTIES = factionEngine.getProperty("NpcPtShowInsideParties", true);
		
		NpcBuffer_SmartWindow = factionEngine.getProperty("EnableSmartWindow", true);
		NpcBuffer_VIP = factionEngine.getProperty("EnableVIP", false);
		NpcBuffer_EnableBuff = factionEngine.getProperty("EnableBuffSection", true);
		NpcBuffer_EnableScheme = factionEngine.getProperty("EnableScheme", true);
		NpcBuffer_EnableHeal = factionEngine.getProperty("EnableHeal", true);
		NpcBuffer_EnableBuffs = factionEngine.getProperty("EnableBuffs", true);
		NpcBuffer_EnableResist = factionEngine.getProperty("EnableResist", true);
		NpcBuffer_EnableSong = factionEngine.getProperty("EnableSongs", true);
		NpcBuffer_EnableDance = factionEngine.getProperty("EnableDances", true);
		NpcBuffer_EnableChant = factionEngine.getProperty("EnableChants", true);
		NpcBuffer_EnableOther = factionEngine.getProperty("EnableOther", true);
		NpcBuffer_EnableSpecial = factionEngine.getProperty("EnableSpecial", true);
		NpcBuffer_EnableCubic = factionEngine.getProperty("EnableCubic", true);
		NpcBuffer_EnableCancel = factionEngine.getProperty("EnableRemoveBuffs", true);
		NpcBuffer_EnableBuffSet = factionEngine.getProperty("EnableBuffSet", true);
		NpcBuffer_EnableFreeBuffs = factionEngine.getProperty("EnableFreeBuffs", true);
		NpcBuffer_EnableTimeOut = factionEngine.getProperty("EnableTimeOut", true);
		NpcBuffer_TimeOutTime = factionEngine.getProperty("TimeoutTime", 10);
		NpcBuffer_MinLevel = factionEngine.getProperty("MinimumLevel", 20);
		NpcBuffer_PriceCancel = factionEngine.getProperty("RemoveBuffsPrice", 100000);
		NpcBuffer_PriceHeal = factionEngine.getProperty("HealPrice", 100000);
		NpcBuffer_PriceBuffs = factionEngine.getProperty("BuffsPrice", 100000);
		NpcBuffer_PriceResist = factionEngine.getProperty("ResistPrice", 100000);
		NpcBuffer_PriceSong = factionEngine.getProperty("SongPrice", 100000);
		NpcBuffer_PriceDance = factionEngine.getProperty("DancePrice", 100000);
		NpcBuffer_PriceChant = factionEngine.getProperty("ChantsPrice", 100000);
		NpcBuffer_PriceOther = factionEngine.getProperty("OtherPrice", 100000);
		NpcBuffer_PriceSpecial = factionEngine.getProperty("SpecialPrice", 100000);
		NpcBuffer_PriceCubic = factionEngine.getProperty("CubicPrice", 100000);
		NpcBuffer_PriceSet = factionEngine.getProperty("SetPrice", 10000000);
		NpcBuffer_PriceScheme = factionEngine.getProperty("SchemePrice", 10000000);
		NpcBuffer_MaxScheme = factionEngine.getProperty("MaxScheme", 4);
		NpcBuffer_MaxBuffs = factionEngine.getProperty("MaxBuffsAmount", 20);
		NpcBuffer_MaxDances = factionEngine.getProperty("MaxDanceAmount", 12);
		NpcBuffer_consumableID = factionEngine.getProperty("ConsumableID", 57);
		
		String[] loc = factionEngine.getProperty("FactionTeam1Base", "").split(",");
		if (loc.length != 5)
		{
			System.out.println("Invalid faction team1 location config.");
		}
		else
		{
			int realLoc[] =
			...
			FACTION_TEAM1_BASE = realLoc;
		}
		
		loc = factionEngine.getProperty("FactionTeam2Base", "").split(",");
		if (loc.length != 5)
		{
			System.out.println("Invalid faction team2 location config.");
		}
		else
		{
			int realLoc[] =
			...
			FACTION_TEAM2_BASE = realLoc;
		}
		
		loc = factionEngine.getProperty("FactionNewbieBase", "").split(",");
		if (loc.length != 5)
		{
			System.out.println("Invalid faction newbie location config.");
		}
		else
		{
			int realLoc[] =
			...
			FACTION_NEWBIE_BASE = realLoc;
		}
		
		FACTION_CUSTOM_SPAWN_Z = factionEngine.getProperty("FactionCustomSpawnZ", 0);
		ENABLE_ONLINE_VC = factionEngine.getProperty("EnableOnlinePlayersVC", false);
		ENABLE_ONLINE_PLAYERS_ON_ENTERWORLD = factionEngine.getProperty("EnableOnlinePlayersEnterworld", false);
		ENABLE_DUALBOX_PROTECTION_IP = factionEngine.getProperty("EnableProtectionIP", false);
		ENABLE_DUALBOX_PROTECTION_CLAN = factionEngine.getProperty("EnableProtectionClan", false);
		ENABLE_DUALBOX_PROTECTION_ALLY = factionEngine.getProperty("EnableProtectionAlly", false);
		ENABLE_DUALBOX_PROTECTION_ARM = factionEngine.getProperty("EnableProtectionArmour", false);
		PROTECTION_ARMOUR_AMOUNT = factionEngine.getProperty("ProtectionArmourAmount", 0);
		ENABLE_PROTECTION_SAME_PLAYER = factionEngine.getProperty("EnableProtectionSamePlayer", false);
		CLASS_BALANCE_MCRIT = factionEngine.getProperty("ClassBalanceMcrit", 4);
		CLASS_BALANCE_MATK = factionEngine.getProperty("ClassBalanceMAtk", 1.00);
		
		FACTION_ENABLE_CHAOS_EVENT = factionEngine.getProperty("EnableChaosEvent", false);
		CHAOS_EVENT_HASTE_LVL = factionEngine.getProperty("SuperHasteLvl", 2);
		CHAOS_EVENT_DURATION_TIME = factionEngine.getProperty("ChaosEventDuration", 20);
		CHAOS_EVENT_INTERVAL = factionEngine.getProperty("ChaosEventInterval", 120);
		CHAOS_EVENT_REWARD_ID = factionEngine.getProperty("ChaosEventRewardId", 57);
		CHAOS_EVENT_REWARD_AMOUNT = factionEngine.getProperty("ChaosEventRewardAmount", 20);
