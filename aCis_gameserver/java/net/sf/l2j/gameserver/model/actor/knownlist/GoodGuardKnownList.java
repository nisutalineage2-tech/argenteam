...
{
    private static Logger _log = Logger.getLogger(GoodGuardKnownList.class.getName());
    ...
    // Property - Public
    @Override
	public final L2GoodGuardInstance getActiveChar() { return (L2GoodGuardInstance)super.getActiveChar(); }
}
