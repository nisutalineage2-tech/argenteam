...
public class EvilGuardKnownList extends AttackableKnownList
{
	...
	public boolean addKnownObject(L2Object object, L2Character dropper)
    {
        ...
        if (object instanceof L2PcInstance)
        {
            ...
            if (FactionWarConfig.isEnabled() && player.getFactionId() == FactionWarConfig.getGoodFactionId())
            {
    ...
    // Property - Public
    @Override
	public final L2EvilGuardInstance getActiveChar() { return (L2EvilGuardInstance)super.getActiveChar(); }
}
